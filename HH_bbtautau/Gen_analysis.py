...
if __name__ == '__main__':
    ...
    df = (
        ...
        .Define("Gen_b_p4",              f"Get_b_p4(Gen_bJets_idx, GenJet_pt, GenJet_eta, GenJet_phi, GenJet_mass)")
...
# ─────────────────────────────────────── Define and plot histograms 1D ────────────────────────────────────────
    ...
    if separate_files:
        ...
        plt.tight_layout()
        plt.yscale('linear')
        plt.savefig("plots/mHH/mHH_GEN_vs_RECO_b_NGT.png", dpi=300, bbox_inches="tight")
        plt.close()
